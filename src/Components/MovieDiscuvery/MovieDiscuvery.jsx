...
<div style={{ height: '80vh', width: '100%', overflow: 'hidden' }}>
  <div id="carouselExampleAutoplaying" className="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000" style={{ height: '100%' }}>
      ...
      {MappingDiscovery.map((Item, index) => (
        <div key={Item.id} className={`carousel-item ${index === 0 ? 'active' : ''}`} style={{ height: '100%' }}>
          <img
            ...
            alt="..."
            style={{height: '100%',objectFit: 'cover',objectPosition: 'center top',filter: 'brightness(60%)',}}/>
          <div className="carousel-caption d-none d-md-block">
          <h1 style={{ color: 'red', fontWeight: 'bold', textShadow: '4px ' }}>{Item.title}</h1>
            <p>{Item.overview}</p>
